...
var require_validation = __commonJS({
  "dist/util/validation.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    var allNum = (arg) => {
      ...
      const firstNonNum = arg.find((anArg) => {
        if (!anyIsUndefined) {
          anyIsUndefined = anArg === void 0;
        }
        return !anyIsUndefined && !(0, exports.isNumber)(anArg);
      });
      if (anyIsUndefined)
        return false;
      if (firstNonNum === void 0)
        return true;
      return false;
    };
...
var require_cliParser = __commonJS({
  "dist/util/cliParser.js"(exports) {
    "use strict";
    var __importDefault = exports && exports.__importDefault || function(mod) {
      return mod && mod.__esModule ? mod : { "default": mod };
    };
    ...
    var string_argv_1 = __importDefault(require_string_argv());
    ...
    var getIsModuleName = (modules) => (str) => {
      if (!modules)
        return false;
      return !!Object.keys(modules).includes(str);
    };
    var parse = (modules, rawOpts, rawIn) => {
      ...
      const ret = input.reduce((accum, curr) => {
        ...
        if (isModuleName(curr)) {
          ...
          if (newCursOpt.type === "bool" || newCursOpt.type === "boolean") {
            ...
            ret2[newCursOptName] = true;
            if (newCursAlias !== null) {
              ret2[newCursAlias] = true;
            }
            return ret2;
          }
          ...
          nms.forEach((optName) => {
            if (void 0 !== ret2[optName] && ["c:c", "commands", "c:n", "names"].includes(optName)) {
              if (!Array.isArray(ret2[optName])) {
                const msg = `value of opt: ${JSON.stringify(opt)}; "ret": ${JSON.stringify(ret2)}; failed invariant; info ${JSON.stringify({
                  temp,
                  optName,
                  ret: ret2,
                  nms,
            ...
            if (void 0 === ret2[optName]) {
              ret2[optName] = newVal;
            } else {
              ret2[optName] = Array.isArray(ret2[optName]) ? [...ret2[optName], newVal] : [ret2[optName], newVal];
            }
          });
          return ret2;
        } else {
    ...
    exports.parse = parse;
    var getMatchingModules = (moduleObj) => (str) => {
...
var require_awaitAll = __commonJS({
  "dist/util/awaitAll.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var isProm = (arg1) => {
      if (arg1 === null)
...
var require_match = __commonJS({
  "dist/match/index.js"(exports) {
    "use strict";
    var __importDefault = exports && exports.__importDefault || function(mod) {
      return mod && mod.__esModule ? mod : { "default": mod };
    };
    Object.defineProperty(exports, "__esModule", { value: true });
    var scalar_1 = __importDefault(require_scalar());
    var cm = {
      help: {
...
var require_evaluator = __commonJS({
  "dist/evaluator.js"(exports) {
    ...
    var cliParser_1 = require_cliParser();
    var awaitAll_1 = __importDefault(require_awaitAll());
...
// dist/util/strlog.js
var require_strlog = __commonJS({
  "dist/util/strlog.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.default = (arg) => console.log(JSON.stringify(arg, null, 2));
  }
});

// dist/util/index.js
var require_util2 = __commonJS({
  "dist/util/index.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
var require_node = __commonJS({
  "dist/node.js"(exports) {
    ...
    var strlog_1 = __importDefault(require_strlog());
    var util_1 = require_util2();
    var id = "CLI";
    exports.apps = {};
    var genericDataHandler = (zodStore, data, params) => {
      zodStore[params.time] = data;
      (0, strlog_1.default)(zodStore);
    };
    var createApp = async (id2) => {
      if ((0, util_1.isNode)()) {
        const { default: repl } = await Promise.resolve().then(() => __importStar(__require("node:repl")));
        exports.apps["CLI"] = { evaluator: (0, evaluator_1.makeRunner)({ id: id2 }), zodStore: {} };
...
var require_browser = __commonJS({
  "dist/browser.js"(exports) {
    ...
    var makeFinalCallback = (id, res) => async (err, result) => {
      if (err)
    ...
    var genericDataHandler = (id, data, params) => {
...
var require_dist = __commonJS({
  "dist/index.js"(exports) {
    ...
    Object.defineProperty(exports, "createServerApp", { enumerable: true, get: function() {
      return node_1.createApp;
    } });
    var browser_1 = require_browser();
    Object.defineProperty(exports, "createBrowserApp", { enumerable: true, get: function() {
      return browser_1.createApp;
    } });
