...
// dist/util/validation.js
var isNumber = function(arg) {
  return arg.match(/^(\-{0,1}[0-9]*\.[0-9]+|^\-{0,1}[0-9]+)$/) !== null;
};
var num = mod.number().or(mod.string().refine(function(val) {
  return isNumber(val);
...
var parseable = mod.string().refine(function(val) {
...
var single = num.or(parseable.transform(function(val) {
  return JSON.parse(val);
})).nullable().or(mod.string());
var parseCli = mod.array(single);
...
var getIsModuleName = function(modules) {
  return function(str) {
    if (!modules)
      return false;
...
var parse = function(modules, rawOpts, rawIn) {
  var opts = __assign(__assign({}, rawOpts), yargsOptions);
  var input = typeof rawIn === "string" ? (0, import_string_argv.default)(rawIn) : rawIn;
  ...
  var ret = input.reduce(function(accum, curr) {
    ...
    if (isModuleName(curr)) {
      ...
      if (newCursAlias === null) {
        var aliasOwner = Object.entries(opts).find(function(_a2) {
          var ownerNm = _a2[0], ownerOpt = _a2[1];
      ...
      var newVal_1 = parsed;
      var currValuation = Object.entries(accum).find(function(_a2) {
        var optName = _a2[0], currVal = _a2[1];
      ...
      nms_1.forEach(function(optName) {
        if (void 0 !== ret_2[optName] && ["c:c", "commands", "c:n", "names"].includes(optName)) {
...
var getMatchingModules = function(moduleObj) {
  return function(str) {
    var _a;
    console.log("get matching module", moduleObj, str);
    if (!moduleObj)
      return;
    var asArgs = (0, import_string_argv.default)(str);
...
var isProm = function(arg1) {
  ...
  if (typeof arg1 === "function")
    return false;
  var isFunc = function(propVal) {
    return typeof propVal === "function";
  };
  return ["catch", "finally", "then"].reduce(function(tOrF, fnName) {
    if (tOrF === false) {
      return false;
    }
    return arg1[fnName] !== void 0 && isFunc(arg1[fnName]);
  }, true);
};
function awaitAll(allProperties) {
  return __awaiter(this, void 0, void 0, function() {
    var props, vals, completions, cb;
    return __generator(this, function(_a) {
      switch (_a.label) {
        case 0:
          props = [];
          vals = [];
          Object.entries(allProperties).forEach(function(_a2) {
            var p = _a2[0], v = _a2[1];
            if (isProm(v)) {
              vals.push(v);
            } else {
          ...
          return [4, Promise.all(vals)];
        case 1:
          completions = _a.sent();
          cb = function(accum, prop, idx) {
            var _a2;
            return __assign2(__assign2({}, accum), (_a2 = {}, _a2[prop] = completions[idx], _a2));
          };
          return [2, props.reduce(cb, {})];
      }
    });
  });
}

// dist/match/scalar.js
  ...
  fn: function scalarMatch(argv) {
    return __awaiter2(this, void 0, void 0, function() {
      ...
      return __generator2(this, function(_a) {
        ...
        return [2, left.map(function(ll, idx) {
          var rt = right[idx];
          return {
            index: idx,
            match: ll === rt,
      ...
      return __generator3(this, function(_a) {
        switch (_a.label) {
          case 0:
            if (!y)
              return [2, null];
            return [4, Promise.all(Object.values(y))];
          case 1:
            childResults = _a.sent();
            return [2, childResults.flat().length];
        }
      });
    });
  },
...
var makeRunner = function(opts) {
  return function(input, dataCallback, finalCallback) {
    return __awaiter4(void 0, void 0, void 0, function() {
      var parsed, matched, modNames, n, successiveCalls_1, _loop_1, allData;
      return __generator4(this, function(_a) {
        switch (_a.label) {
          case 0:
            parsed = parse({ match: match_default }, yargsOptions, input);
            matched = getMatchingModules({ match: match_default })(input);
            if (!matched.length)
              return [3, 2];
            matched.reverse();
            modNames = __spreadArray2([], parsed.moduleNames, true);
            modNames.reverse();
            n = 0;
            successiveCalls_1 = {};
            _loop_1 = function() {
              var o = n;
              var moduleName = modNames[o];
              successiveCalls_1[moduleName] = function() {
                return matched[o].fn.call(null, parsed, successiveCalls_1);
              }();
              n += 1;
            };
            do {
            ...
            return [4, awaitAll(successiveCalls_1)];
          case 1:
            allData = _a.sent();
...
// dist/util/strlog.js
var strlog_default = function(arg) {
...
var id = "CLI";
var apps = {};
var genericDataHandler = function(zodStore, data, params) {
  zodStore[params.time] = data;
  strlog_default(zodStore);
};
var createApp = function(id2) {
  return __awaiter5(void 0, void 0, void 0, function() {
    var repl, appDataHandler_1;
    return __generator5(this, function(_a) {
      switch (_a.label) {
        case 0:
          if (!isNode())
            return [3, 2];
          return [4, import("node:repl")];
        case 1:
          repl = _a.sent()["default"];
          apps["CLI"] = { evaluator: makeRunner({ id: id2 }), zodStore: {} };
          appDataHandler_1 = function(input, data) {
            genericDataHandler(apps["CLI"].zodStore, data, { time: Date.now() });
          };
          repl.start({
            prompt: "> ",
            eval: function(input, cyx, fn, cb) {
              return __awaiter5(void 0, void 0, void 0, function() {
                return __generator5(this, function(_a2) {
                  apps["CLI"].evaluator(input, appDataHandler_1, cb);
                  return [2];
                });
              });
            }
...
var apps2 = {};
var makeFinalCallback = function(id2, res) {
  return function(err, result) {
    return __awaiter6(void 0, void 0, void 0, function() {
      return __generator6(this, function(_a) {
        ...
        apps2[id2].restarter = makeProm(id2);
        return [2];
      });
    });
  };
};
var genericDataHandler2 = function(id2, data, params) {
  var zodStore = apps2[id2].zodStore;
  zodStore[params.time] = data;
  var dataEl = apps2[id2].dataEl;
  dataEl.innerHTML = "".concat(dataEl.innerHTML, "\n").concat(JSON.stringify(data, null, 2));
};
var createApp2 = function(id2) {
  return __awaiter6(void 0, void 0, void 0, function() {
    return __generator6(this, function(_a) {
      apps2[id2] = {
        el: document.querySelector("textarea"),
        dataEl: document.querySelector("pre"),
        evaluator: makeRunner({ id: id2 }),
        zodStore: {},
        dataHandler: function(input, data) {
          genericDataHandler2(id2, data, { time: Date.now() });
        },
        restarter: null
      };
      apps2[id2].restarter = makeProm(id2);
...
function makeProm(id2) {
  return new Promise(function(res) {
    apps2[id2].el.onkeyup = function(ev) {
      if (ev.key === "Enter") {
        var t = apps2[id2].el.value;
        apps2[id2].el.value = "";
        apps2[id2].evaluator(t, apps2[id2].dataHandler, makeFinalCallback(id2, res));
      } else {
        console.log("asdf", apps2[id2].el.value);
      }
    };
  });
}

// dist/testable/app.js
createApp2("1");
